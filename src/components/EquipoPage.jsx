...
const profesores = [
  ...
  },
  {
    ...
    bio: `Javier Rodríguez Vidal received his B.Sc. degree in Computer Science (2010) and an M.Sc. degree in Computer Science Research (2011) from Universidad Complutense de Madrid (UCM), along with a Ph.D. in Intelligent Systems (2019) from Universidad Nacional de Educación a Distancia (UNED). 

          From 2011-2015 he worked as a Junior Programmer and Solutions Assistant at Everis S.L.U. 

          Transitioning to Academia, he achieved a pre-doctoral contract (FPI) to complete his Ph.D. Also, he worked as a post-doctoral researcher in the MEDAL group at the Center for Biomedical Tecnhology of the Universidad Politécnica de Madrid (UPM) from 2020 to 2021. Afterwards, he attained an Assistant Professor position at the Escuela Técnica Superior de Ingenieros Industriales of the UPM, where he is currently.
  ...
  },
  {
    ...
    bio: `Graduado en ingeniero de organización por la Escuela Técnica Superior de Ingenieros Industriales de la UPM. Posee estudios en matemática computacional y aplicada y un máster en formación del profesorado en matemáticas. Es funcionario como profesor de matemáticas en educación secundaria y bachillerato, y también es empresario.

          Fundador y director general de acaKER, una consultora tecnológica, y del Instituto Superior de Formación Profesional Vigara, se especializa en el desarrollo de ERPs y sistemas de información. Ha impartido docencia en la Universidad Carlos III de Madrid y la Universidad CEU San Pablo. Actualmente, realiza sus estudios de doctorado en ingeniería mecánica, enfocándose en la aplicación de inteligencias artificiales a diversos procesos y datos.`,
    rrss: [
  ...
  },
  {
    ...
    bio: `Estudiante del grado de Ingeniería en Tecnologías Industriales de la Universidad Politécnica de Madrid, especializada en automática y electrónica. Actualmente se encuentra en la fase final de su grado y está trabajando en su Trabajo de Fin de
          Grado (TFG). 

          Su proyecto de TFG consiste en evaluar la eficiencia de las
          inteligencias artificiales generativas en la creación de código fuente,
          y en cómo puede influir en la docencia de la asignatura Fundamentos de
          Programación.`, 
  },
  {
    id: 7,
    ...
    bio: `Recién titulado en Técnico Superior en Desarrollo de Aplicaciones Web (DAW) y cursando el segundo año del Grado de Ingeniería en Informática en la Universidad Nacional de Educación a Distancia (UNED).

          Durante mis prácticas profesionales en la Escuela Técnica Superior de Ingenieros Industriales (UPM), he estado involucrado en la creación del sitio web del equipo de informática industrial de la universidad. 

          A lo largo de mi formación, he adquirido conocimientos en diversas tecnologías y lenguajes de programación, incluyendo HTML, CSS, JavaScript, Java, MySQL y PHP.

          Fuera del ámbito académico y profesional, disfruto de la programación y la resolución de problemas complejos, lo que me lleva a estar en constante aprendizaje y actualización en las últimas tendencias tecnológicas. 

          fernandodeveloper89@gmail.com`,
    rrss: [
      { icon: "/public/InstagramIcon.png", url: "https://www.instagram.com/ferprofe10/" }
    ]
  },
  {
    id: 8,
    ...
    bio: `Entusiasta de la informática y el desarrollo de aplicaciones web. Desde pequeño, he mostrado un gran interés por la tecnología y la programación, lo que me llevó a formarme en este ámbito.

          Completé el Bachillerato en Ciencias Sociales en el IES Vega del Jarama en 2022. Posteriormente, me matriculé en el ciclo formativo de Desarrollo de Aplicaciones Web en el IES Los Olivos, donde he titulado recientemente.

          Durante las prácticas profesionales en la Escuela Técnica Superior de Ingenieros Industriales (UPM), he estado involucrado en la creación del sitio web del equipo de informática industrial de la universidad.

          A lo largo de mi formación, he adquirido conocimientos en diversas tecnologías y lenguajes de programación, incluyendo HTML, CSS, JavaScript, Java, MySQL y PHP.

          Fuera del ámbito académico y profesional, disfruto de la programación y la resolución de problemas complejos, lo que me lleva a estar en constante aprendizaje y actualización en las últimas tendencias tecnológicas. 

          Paulcazorla24@gmail.com`,
    rrss: [
      { icon: "/public/InstagramIcon.png", url: "https://www.instagram.com/paul24_10/" }
    ]
  },
  {
    id: 9,
    ...
    bio: `Titulado de Grado Superior en Desarrollo de Aplicaciones Web (DAW), con una orientación clara hacia la resolución de desafíos técnicos y la mejora continua en el ámbito digital.

          Mi trayectoria académica se ha enfocado en adquirir y aplicar habilidades avanzadas en programación y diseño web, lo cual me ha permitido participar activamente en la optimización de diversos aspectos de la página en la que colaboro.

          Dentro de mis responsabilidades destacan la identificación de áreas de mejora en la estructura y funcionalidad del sitio, así como la implementación de soluciones que favorecen una experiencia de usuario más eficiente y amigable.
  ...
  },
  {
    ...
    bio: `Técnico Superior en Desarrollo de Aplicaciones Web (DAW). Encargado del desarrollo y mejora del sitio web del equipo de informática industrial de la universidad en la Escuela Técnica Superior de Ingenieros Industriales (UPM), Conocimientos en diversas tecnologías y lenguajes de programación, incluyendo HTML, CSS, JavaScript, Java, MySQL, PHP y Python.`,
    rrss: [
      { icon: "/public/LinkedinIcon.png", url: "https://www.linkedin.com/in/ra%C3%BAl-mart%C3%ADn-mill%C3%A1n-87999915a/?trk=profile-badge&originalSubdomain=es" }
    ]
  },
]
